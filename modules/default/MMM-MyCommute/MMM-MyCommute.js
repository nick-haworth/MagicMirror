...
Module.register('MMM-MyCommute', {
  ...
  defaults: {
    apikey: 'AIzaSyB8splRCpxNSxCzAzQzwzM-FPDE77ToHQ8',
    origin: 'Flat b, 160 Stonhouse St, London SW4 6BE',
    startTime: '00:00',
    endTime: '23:59',
    hideDays: [],
    showSummary: true,
    ...
    pollFrequency: 10 * 60 * 3000, //every ten minutes, in milliseconds
    destinations: [
      {
        destination: '2 Marylebone Road, London NW1 4DF',
        label: 'Work',
        mode: 'transit',
        time: null
      }
